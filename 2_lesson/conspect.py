...
# print(a + b)
# print(a + 5) # "5" транслдируется в вектор [5, 5, 5], т. е. она подстраивается под размер массива а
...
# Xmean0 = X.mean(axis=0)
# print(Xmean0)
# Xcenter0 = X - Xmean0
# print(Xcenter0)

# Xmean1 = X.mean(axis=1)
# print(Xmean1)
