...
# Если размерность данных > 2, то использует иерархическую индексацию (мультииндекс). В один индекс включается несколько уровней
...
## - список массивов, которые задают значение индекса на каждом уровне
...
# # - список кортежей, задающих значение индекса в кажой точке
...
# # - описание внутреннего предстаавления: levels - список списков, codes - список меток
# i4 = pd.MultiIndex(
#     levels=[
#         ['a', 'b', 'c'],
#         [1, 2],
...
# # Уровням можно задвать названия
...
#  для city_1 и одновременно job_2
...
# - все данные по первому городу(city_1) и первым двум person-ам (person_1, person_2) (с использованием срезов)
#
# Приведите пример (самостоятелньо) с использованием pd.IndexSlice
