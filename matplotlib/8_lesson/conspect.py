...
# ax.plot_trisurface(x, y, z, cmap='viridis')
...
# 0 - независимы
# 1 - положительная зависимость, чем 1 значение больше, тем больше другое
# -1 - отрицательная зависимость, чем 1 значение больше, тем меньше другое
